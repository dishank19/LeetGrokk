...
- [X] https://leetcode.com/problems/maximum-subarray/  (Blind) - NOT SLIDING WINDOW!!
...
- [X] https://leetcode.com/problems/longest-repeating-character-replacement/ (Blind) ```REVISIT```
- [X] https://leetcode.com/problems/max-consecutive-ones-iii/ ```REVISIT``` ✅
- [X] https://leetcode.com/problems/permutation-in-string/
- [X] https://leetcode.com/problems/find-all-anagrams-in-a-string/ ```REVISIT```
- [X] https://leetcode.com/problems/minimum-window-substring/ (Blind) ```REVISIT```
...
- [X] https://leetcode.com/problems/happy-number/ ```Detect cycles instead of fast and slow pointer approach``` ```REVISIT```
- [X] https://leetcode.com/problems/middle-of-the-linked-list/
- [X] https://leetcode.com/problems/palindrome-linked-list/ ```REVISIT AFTER SEEING HOW TO REVERSE A LINKED LIST```
